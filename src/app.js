...
const NAV = [
  ...
  { route: "lessons", label: "Aprender", icon: "📚" },
...
function renderNav() {
  ...
  `).join("") + `
    <button class="nav-item ${route === "profile" ? "active" : ""}" data-route="profile" style="margin-top:8px;">
      <span class="nav-icon">⚙️</span> Mi perfil
    </button>
  `;
